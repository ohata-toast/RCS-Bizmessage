...
1. 발신 브랜드를 선택합니다.
2. 대화방(발신번호)를 선택합니다.
3. 발신 내용이 광고인지 아닌지 선택합니다. 광고인 경우 080 수신거부 번호를 선택해야합니다.
4. 발송 유형을 SMS로 선택합니다.
5. 메시지 내용(최대 100자)을 입력합니다.
6. 버튼이 필요한 경우 버튼을 추가합니다.(최대 1개)
...
3. 발신 내용이 광고인지 아닌지 선택합니다. 광고인 경우 080 수신거부 번호를 선택해야합니다.
4. 발송 유형을 LMS로 선택합니다.
5. 메시지 제목(최대 30자)과 내용(최대 1300자)을 입력합니다.
6. 버튼이 필요한 경우 버튼을 추가합니다.(최대 3개)
7. 우측의 수신자 설정에서 발송할 수신 번호를 작성하고 추가 버튼을 클릭합니다.(최대 50명)
8. 발송 버튼을 클릭합니다.
...
3. 발신 내용이 광고인지 아닌지 선택합니다. 광고인 경우 080 수신거부 번호를 선택해야합니다.
4. 발송 유형을 MMS로 선택합니다.
5. 상세 선택에서 가로형 또는 세로형을 선택합니다.
6. 메시지 제목(최대 30자)과 내용(최대 1300자)을 입력합니다.
7. 발송할 이미지를 업로드합니다.(최대 1개)
8. 버튼이 필요한 경우 버튼을 추가합니다.(카드당 최대 2개)
...
* 토글버튼을 클릭하면 **SMS 서비스를 활성화**가 노출됩니다.
    * 프로젝트에 SMS 서비스가 비활성화 상태인 경우, 버튼을 클릭하면 해당 프로젝트 SMS 서비스가 활성화됩니다.
    * 프로젝트에 SMS 서비스가 활성화 상태인 경우, 버튼이 비활성화 상태로 노출됩니다.

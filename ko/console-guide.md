...
*  브랜드 개설 페이지 상단의 브랜드 가이드를 클릭해 관련 가이드를 참고할 수 있습니다.
...
6. 메시지 내용(최대 100자) 및 버튼(최대 1개)을 추가합니다.
7. 수신자 설정에서 발송할 수신 번호를 입력한 뒤 추가를 클릭합니다. 최대 50명까지 추가할 수 있습니다.
8. **발송**을 클릭합니다.
...
2. 대화방(발신번호)를 선택합니다.
3. 발신 내용이 광고인지 아닌지 선택합니다. 광고인 경우 080 수신거부 번호를 선택해야 합니다.
4. **발송 관리**에서 SMS 이용 설정을 진행합니다.
5. 발송 유형을 **LMS**로 선택합니다.
6. 메시지 제목(최대 30자), 내용(최대 1,300자), 버튼(최대 3개)을 추가합니다.
7. 수신자 설정에서 발송할 수신 번호를 작성하고 추가를 클릭합니다. 최대 50명까지 추가할 수 있습니다.
8. **발송**을 클릭합니다.
...
7. 카드별로 제목(최대 30자), 내용(최대 1,300자), 이미지(최대 1개), 버튼(카드당 최대 2개)을 추가합니다.
8. 수신자 설정에서 발송할 수신 번호를 작성하고 추가를 클릭합니다. 최대 50명까지 추가할 수 있습니다.
9. **발송**을 클릭합니다.
...
4. **발송 관리**에서 SMS 이용 설정을 진행합니다.
5. 발송 유형을 **MMS**로 선택합니다.
6. 상세 선택에서 슬라이드형과 슬라이드 크기를 선택합니다.
7. 메시지의 슬라이드 개수를 설정합니다(최소 3개, 최대 6개).
8. 카드별로 제목(최대 30자), 내용(최대 30자), 이미지(최대 1개), 버튼(최대 2개)을 입력합니다.
9. 수신자 설정에서 발송할 수신 번호를 작성하고 추가를 클릭합니다. 최대 50명까지 추가할 수 있습니다.
10. **발송**을 클릭합니다.
